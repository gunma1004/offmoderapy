...
seoul_regions = {
    ...
    "seongbuk": {"name": "성북동", "dongs": ["성북동", "삼선동", "동선동", "돈암동", "안암동", "보문동", "정릉동", "길음동", "종암동", "월곡동", "장위동", "석관동"]},
...
gyeonggi_regions = {
    ...
    "gwangmyeong": {"name": "광명동", "dongs": ["광명동", "철산동", "하안동", "소하동"]},
...
incheon_regions = {
    ...
    "bupyeong": {"name": "부평동", "dongs": ["부평동", "산곡동", "청천동", "갈산동", "삼산동", "부개동"]},
